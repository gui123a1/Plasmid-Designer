...
tests/                      后端 pytest（180 用例，含 test_sanger_pipeline/test_enzyme_sites/
...
- pytest **180 通过**（含 test_vector_data 数据守门 6 项、test_reference_parser 8 项、CDS 测序结论 6 项）；前端 vitest **67 通过**；vite build 通过
