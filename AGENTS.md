...
tests/                      后端 pytest（205 用例，含 test_sanger_pipeline/test_enzyme_sites/
...
- pytest **205 通过**（含 test_vector_data 数据守门 6 项、test_reference_parser 10 项、CDS 测序结论 13 项、峰级证据/ORF 对齐/嵌套去重/置信度分层等）；前端 vitest **69 通过**；vite build 通过
